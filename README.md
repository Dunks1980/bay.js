...
| inner-html="#target" | Used to tell the component where it should render \<inner-html>\</inner-html> content. If not specified it will render to Ligh DOM. | [Inner HTML](https://bayjs.org/examples?tab=tags&item=example_tags_innerhtml_render) |
